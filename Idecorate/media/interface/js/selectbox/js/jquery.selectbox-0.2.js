...
(function ($, undefined) {
	...
	$.extend(Selectbox.prototype, {
		...
		_attachSelectbox: function (target, settings) {
			...
			function getOptions () {
				var option_value;
				var option_image = $('<img/>');//create images
				...
				arguments[0].each(function (i) {
					...
					if (!that.is(":disabled") && !disabled) {
						child = $("<a>", {
							"href": "#" + that.val(),
							"rel": that.val()
						}).append(option_value).bind("click.sb", function (e) {
		 ...
		 * @param {String} text
		 */
		_changeSelectbox: function (target, value, html) {
			var onChange,
				inst = this._getInst(target);
				
				var isfound = inst.settings.imageRegExp.test(html);
				var option_value = isfound ? $(html): html;
