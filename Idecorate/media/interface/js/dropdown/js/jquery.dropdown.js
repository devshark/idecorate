...
(function($){
	$.fn.dropdown = function(options){
		...
		return this.each(function(){
			...
			var submenus = $(this).find('ul').addClass(options.subClass);
			...
			if($('.dropdown li').has('ul').length){
				$('ul').parent().find(options.linkTag+':first').addClass('hasSub');
				$('ul').parent().find(options.noLinkTag+':first').addClass('hasSub');
