...
class AddProductForm(forms.Form):
	...
	guest_table = forms.ChoiceField(label=_("Guest Table"), choices=(('3','No default'),('1','Table'),('2','Guest'),), required=False,widget=forms.Select)
...
class HomeBannerForm(forms.Form):
	...
	wholename = forms.CharField(required=False)
	wholedescription = forms.CharField(required=False)
	...
	half1name = forms.CharField(required=False)
	half2name = forms.CharField(required=False)
	half1description = forms.CharField(required=False)
	half2description = forms.CharField(required=False)
	...
	third1name = forms.CharField(required=False)
	third2name = forms.CharField(required=False)
	third3name = forms.CharField(required=False)
	third1description = forms.CharField(required=False)
	third2description = forms.CharField(required=False)
	third3description = forms.CharField(required=False)
