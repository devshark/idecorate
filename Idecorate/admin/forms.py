...
class AddProductForm(forms.Form):
	...
	default_quantity = forms.IntegerField(label=_("Default Quantity"),required=False,initial=1,error_messages={'invalid':_('Enter a whole number in Default Quantity field.')})
